...
// this middleware will not executed for above two routes defined, as they have already sent response,
// above have already ended the request response cycle
// middleware order is really important - depends upon definition in code
// app.use((req, res, next) => {
//     console.log("Hello from the middleware after get & post 👽");
//     next();
// });
